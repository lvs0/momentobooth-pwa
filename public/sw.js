...
const CACHE = "momentobooth-v19";
/* ⚠️ Les URLs versionnées (?v=19) doivent MATCHER celles de index.html ET les imports de app.js :
...
const ASSETS = [
  ...
  "/js/masks.js?v=19",
  "/js/frames.js?v=19",
  "/js/vendor/gif.js?v=19",
  "/js/vendor/gif.worker.js",
  "/js/vendor/jszip.min.js?v=19",
